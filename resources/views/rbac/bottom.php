...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="footer">
    <tr>
        <td align="left" valign="middle" class="footer_pad">COPYRIGHT©2018<a href="#" target="_blank">秘银互动</a> </td>
        <td align="right" valign="middle" class="footer_pad"><img src="/images/main/why.gif" width="12" height="12" alt="疑问图标" align="absmiddle">&nbsp;&nbsp;如有疑问请您联系TEL：010-000000</td>
    </tr>
</table>
</body>
</html>