...
class PayController extends Controller
{
  ...
  protected $config = [
        ...
        'notify_url' => 'http://api.mithrilgaming.com:8888/Pay/notify',//notify_url 代表服务器端回调地址，return_url 代表前端回调地址
        'return_url' => 'http://api.mithrilgaming.com:8888/Pay/notify',//http://yansongda.cn/return.php
